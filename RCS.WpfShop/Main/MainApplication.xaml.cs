...
namespace RCS.WpfShop.Main
{
    public partial class MainApplication : Application
    {
        ...
        {
            e.Handled = true;
            DisplayAlert(e.Exception);
        }

        private void CurrentDomain_UnhandledException(object sender, UnhandledExceptionEventArgs e)
        {
            DisplayAlert((Exception)e.ExceptionObject);
        }
        ...
        protected void DisplayAlert(Exception exception)
        {
            ...
            var result = MessageBox.Show(Labels.ErrorUnknown, Labels.Error, MessageBoxButton.YesNo, MessageBoxImage.Warning);
